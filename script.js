...
addItemButton.addEventListener('click', () => {
    ...
    if (name && description && !isNaN(price) && !isNaN(quantity)) {
     axios.post("https://crudcrud.com/api/29d2ab4ed2004bd69c59dee07969657f/addItem",{name:name , description : description , price : price , quantity : quantity})
     .then(()=>{
        clearInputFields();
        console.log("sucess")
        fetchData();
...
function fetchData() {
    axios.get('https://crudcrud.com/api/29d2ab4ed2004bd69c59dee07969657f/addItem')
        .then((response) => {
...
function updateQuantity(row) {
    ...
    axios
        .put(`https://crudcrud.com/api/29d2ab4ed2004bd69c59dee07969657f/addItem/${itemId}`, updatedItem)
        .then((response) => {
